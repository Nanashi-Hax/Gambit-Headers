#include "Gambit/Game/BulletBombBase.hpp"
#include "Gambit/Game/BulletBombInstant.hpp"
#include "Gambit/Game/BulletCloneHandle.hpp"
#include "Gambit/Game/BulletMgr.hpp"
#include "Gambit/Game/CloneObjMgr.hpp"
#include "Gambit/Game/MainMgrBase.hpp"
#include "Gambit/Game/Player.hpp"
#include "Gambit/Game/PlayerInkAction.hpp"
#include "Gambit/Game/PlayerParam.hpp"
            ...
            if (type != BulletMgr::BulletType::Invalid)
            {
                BulletBombBase* bullet = reinterpret_cast<BulletBombBase*>(MainMgrBase::sInstance->bulletMgr->activateOneCancelUnnecessary(type,true,&position,&velocity));
                {
                    if(bullet)
                    {
                        ...
                        player->startMotion_BombThrow(false, true);
                        setInkRecoverFrm(0x28, true, true);
                    }
                }
            }
        }
